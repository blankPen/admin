...
VForm.create = function(opt){
    return function(Component){
        ...
        return createForm(opt)((props)=>{
            let form = Validator.getForm(props.form);
...
VForm.Item = class extends React.Component {
    static propTypes = {
        ...
        getValueFromEvent: React.PropTypes.string,
...
const METHODS = {
    ...
    rangelength: function( value, param ) {
        return isNull(value) || ( value.length >= param['min'] && length <= param['max'] );
    },
